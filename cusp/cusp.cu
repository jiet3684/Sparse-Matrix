...
int main(int argc, char* argv[])
{
    ...
    cusp::csr_matrix<int, int, cusp::device_memory> B;
    ...
    cusp::csr_matrix<int, int, cusp::device_memory> C(A.num_rows, A.num_cols, mem_total);
    double t_spgemm=0.0;
    for(int t=0;t<TRY;t++){ 
        timer2.Start();
        // compute y = A * x
